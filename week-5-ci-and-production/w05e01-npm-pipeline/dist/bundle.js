(function () {
  ...
  function checkRecursiveUpdates(seen, fn) {
      if (!seen.has(fn)) {
          ...
          if (count > RECURSION_LIMIT) {
              ...
              warn$1$1(`Maximum recursive updates exceeded${componentName ? ` in component <${componentName}>` : ``}. ` +
  ...
  function emit$1(instance, event, ...rawArgs) {
          ...
          if (emitsOptions) {
              if (!(event in emitsOptions) &&
                  ...
                  if (!propsOptions || !(toHandlerKey(event) in propsOptions)) {
                      warn$1$1(`Component emitted event "${event}" but it is neither declared in ` +
      ...
      }
      {
          ...
          if (lowerCaseEvent !== event && props[toHandlerKey(lowerCaseEvent)]) {
              warn$1$1(`Event "${lowerCaseEvent}" is emitted in component ` +
  ...
  function renderComponentRoot(instance) {
          ...
          if (keys.length) {
              if (shapeFlag & (1 /* ShapeFlags.ELEMENT */ | 6 /* ShapeFlags.COMPONENT */)) {
                  ...
                  if (extraAttrs.length) {
                      warn$1$1(`Extraneous non-props attributes (` +
                          `${extraAttrs.join(', ')}) ` +
                          `were passed to component but could not be automatically inherited ` +
                          `because component renders fragment or text root nodes.`);
                  }
                  if (eventAttrs.length) {
                      warn$1$1(`Extraneous non-emits event listeners (` +
                          `${eventAttrs.join(', ')}) ` +
                          `were passed to component but could not be automatically inherited ` +
                          `because component renders fragment or text root nodes. ` +
      ...
      if (vnode.dirs) {
          if (!isElementRoot(root)) {
              warn$1$1(`Runtime directive used on component with non-element root node. ` +
      ...
      if (vnode.transition) {
          if (!isElementRoot(root)) {
              warn$1$1(`Component inside <Transition> renders non-element root node ` +
  ...
  function watch(source, cb, options) {
      if (!isFunction(cb)) {
          warn$1$1(`\`watch(fn, options?)\` signature has been moved to a separate API. ` +
  ...
  function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = EMPTY_OBJ) {
      if (!cb) {
          if (immediate !== undefined) {
              warn$1$1(`watch() "immediate" option is only respected when using the ` +
                  `watch(source, callback, options?) signature.`);
          }
          if (deep !== undefined) {
              warn$1$1(`watch() "deep" option is only respected when using the ` +
                  `watch(source, callback, options?) signature.`);
          }
      }
      const warnInvalidSource = (s) => {
          warn$1$1(`Invalid watch source: `, s, `A watch source can only be a getter/effect function, a ref, ` +
                  ...
                  for (const c of children) {
                      if (c.type !== Comment) {
                          if (hasFound) {
                              ...
                              warn$1$1('<transition> can only be used on a single element or component. ' +
          ...
          return (pendingRequest ||
              (thisRequest = pendingRequest =
                  loader()
                      ...
                      if (!comp) {
                          warn$1$1(`Async component loader resolved to undefined. ` +
  ...
  function injectHook(type, hook, target = currentInstance, prepend = false) {
      if (target) {
          ...
          warn$1$1(`${apiName} is called when there is no active component instance to be ` +
              `associated with. ` +
  ...
  */
  ...
  function resolveAsset(type, name, warnMissing = true, maybeSelfReference = false) {
      ...
      if (instance) {
          ...
          warn$1$1(`resolve${capitalize(type.slice(0, -1))} ` +
  ...
  fallback, noSlotted) {
      ...
      if (slot && slot.length > 1) {
          warn$1$1(`SSR-optimized slot function detected in a non-SSR-optimized render ` +
  ...
  const PublicInstanceProxyHandlers = {
      get({ _: instance }, key) {
          ...
          ((globalProperties = appContext.config.globalProperties),
              ...
              if (data !== EMPTY_OBJ && isReservedPrefix(key[0]) && hasOwn(data, key)) {
                  warn$1$1(`Property ${JSON.stringify(key)} must be accessed via $data because it starts with a reserved ` +
                      `character ("$" or "_") and is not proxied on the render context.`);
              }
              else if (instance === currentRenderingInstance) {
                  warn$1$1(`Property ${JSON.stringify(key)} was accessed during render ` +
      ...
      set({ _: instance }, key, value) {
          ...
          if (key[0] === '$' && key.slice(1) in instance) {
              warn$1$1(`Attempting to mutate public property "${key}". ` +
  ...
  };
  {
      PublicInstanceProxyHandlers.ownKeys = (target) => {
          warn$1$1(`Avoid app logic that relies on enumerating keys on a component instance. ` +
  ...
  const RuntimeCompiledPublicInstanceProxyHandlers = /*#__PURE__*/ extend({}, PublicInstanceProxyHandlers, {
      ...
      has(_, key) {
          ...
          if (!has && PublicInstanceProxyHandlers.has(_, key)) {
              warn$1$1(`Property ${JSON.stringify(key)} should not start with _ which is a reserved prefix for Vue internals.`);
          }
          return has;
      }
  });
      ...
      Object.keys(toRaw(setupState)).forEach(key => {
          if (!setupState.__isScriptSetup) {
              if (isReservedPrefix(key[0])) {
                  warn$1$1(`setup() return property ${JSON.stringify(key)} should not start with "$" or "_" ` +
  ...
  function applyOptions(instance) {
      ...
      if (methods) {
          for (const key in methods) {
              ...
              if (isFunction(methodHandler)) {
                  ...
                  warn$1$1(`Method "${key}" has type "${typeof methodHandler}" in the component definition. ` +
      ...
      if (dataOptions) {
          if (!isFunction(dataOptions)) {
              warn$1$1(`The data option must be a function. ` +
                  `Plain object usage is no longer supported.`);
          }
          const data = dataOptions.call(publicThis, publicThis);
          if (isPromise(data)) {
              warn$1$1(`data() returned a Promise - note data() cannot be async; If you ` +
      ...
      for (const key in injectOptions) {
          ...
          if (isRef(injected)) {
              ...
              if (unwrapRef) {
                  ...
                  {
                      warn$1$1(`injected property "${key}" is a ref and will be auto-unwrapped ` +
  ...
  function mergeOptions$1(to, from, strats, asMixin = false) {
      ...
      for (const key in from) {
          if (asMixin && key === 'expose') {
              warn$1$1(`"expose" option is ignored when declared in mixins or extends. ` +
  ...
  const normalizeSlot$1 = (key, rawSlot, ctx) => {
      ...
      const normalized = withCtx((...args) => {
          if (true && currentInstance) {
              warn$1$1(`Slot "${key}" invoked outside of the render function: ` +
  ...
  const normalizeObjectSlots = (rawSlots, slots, instance) => {
      ...
      for (const key in rawSlots) {
          ...
          if (isFunction(value)) {
              ...
              {
                  warn$1$1(`Non-function value encountered for slot "${key}". ` +
  ...
  const normalizeVNodeSlots = (instance, children) => {
      if (!isKeepAlive(instance.vnode) &&
          !(false )) {
          warn$1$1(`Non-function value encountered for default slot. ` +
              `Prefer function slots for better performance.`);
      }
          ...
          const app = (context.app = {
              ...
              use(plugin, ...options) {
                  if (installedPlugins.has(plugin)) {
                      ...
                      warn$1$1(`A plugin must either be a function or an object with an "install" ` +
                          `function.`);
                  }
                  return app;
              },
              mixin(mixin) {
                  {
                      if (!context.mixins.includes(mixin)) {
                          ...
                          warn$1$1('Mixin has already been applied to target app' +
              ...
              mount(rootContainer, isHydrate, isSVG) {
                  if (!isMounted) {
                      ...
                      if (rootContainer.__vue_app__) {
                          warn$1$1(`There is already an app instance mounted on the host container.\n` +
              ...
              provide(key, value) {
                  if (key in context.provides) {
                      warn$1$1(`App already provides property with key "${String(key)}". ` +
  ...
  function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
      ...
      if (!owner) {
          warn$1$1(`Missing ref owner context. ref cannot be used on hoisted vnodes. ` +
  ...
  function createHydrationFunctions(rendererInternals) {
      ...
      const hydrate = (vnode, container) => {
          if (!container.hasChildNodes()) {
              warn$1$1(`Attempting to hydrate existing markup but container is empty. ` +
              ...
              case Text:
                  if (domType !== 3 /* DOMNodeTypes.TEXT */) {
                      ...
                      if (node.data !== vnode.children) {
                          hasMismatch = true;
                          warn$1$1(`Hydration text mismatch:` +
          ...
          // #5405 in dev, always hydrate children for HMR
          {
              ...
              if (shapeFlag & 16 /* ShapeFlags.ARRAY_CHILDREN */ &&
                  ...
                  while (next) {
                      hasMismatch = true;
                      if (!hasWarned) {
                          warn$1$1(`Hydration children mismatch in <${vnode.type}>: ` +
                  ...
                  if (el.textContent !== vnode.children) {
                      hasMismatch = true;
                      warn$1$1(`Hydration text content mismatch in <${vnode.type}>:\n` +
      ...
      const hydrateChildren = (node, parentVNode, container, parentComponent, parentSuspense, slotScopeIds, optimized) => {
          ...
          for (let i = 0; i < l; i++) {
              ...
              if (node) {
                  ...
                  hasMismatch = true;
                  if (!hasWarned) {
                      warn$1$1(`Hydration children mismatch in <${container.tagName.toLowerCase()}>: ` +
  ...
  const resolveTarget = (props, select) => {
      ...
      if (isString(targetSelector)) {
          if (!select) {
              warn$1$1(`Current renderer does not support string target for Teleports. ` +
              ...
              if (!target) {
                  warn$1$1(`Failed to locate Teleport target with selector "${targetSelector}". ` +
              ...
              if (disabled) {
                  ...
                  if ((n2.props && n2.props.to) !== (n1.props && n1.props.to)) {
                      ...
                      if (nextTarget) {
                          ...
                          warn$1$1('Invalid Teleport target on update:', target, `(${typeof target})`);
                      }
                  }
                  else if (wasDisabled) {
                      // disabled -> enabled
  ...
  function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
      ...
      if (shapeFlag & 4 /* ShapeFlags.STATEFUL_COMPONENT */ && isProxy(type)) {
          type = toRaw(type);
          warn$1$1(`Vue received a Component which was made a reactive object. This can ` +
  ...
  function setupStatefulComponent(instance, isSSR) {
      ...
      const Component = instance.type;
      {
          ...
          if (Component.compilerOptions && isRuntimeOnly()) {
              warn$1$1(`"compilerOptions" is only supported when using a build of Vue that ` +
          ...
          if (isPromise(setupResult)) {
              ...
              if (isSSR) {
                  ...
                  if (!instance.suspense) {
                      ...
                      warn$1$1(`Component <${name}>: setup function returned a promise, but no ` +
  ...
  function handleSetupResult(instance, setupResult, isSSR) {
      if (isFunction(setupResult)) {
          ...
          if (isVNode(setupResult)) {
              warn$1$1(`setup() should not return VNodes directly - ` +
  ...
  function finishComponentSetup(instance, isSSR, skipOptions) {
      ...
      if (!Component.render && instance.render === NOOP && !isSSR) {
          ...
          if (!compile && Component.template) {
              warn$1$1(`Component provided template option but ` +
  ...
  // dev only
  const warnRuntimeUsage = (method) => warn$1$1(`${method}() is a compiler-hint helper that is only usable inside ` +
  ...
  function withAsyncContext(getAwaitable) {
      ...
      if (!ctx) {
          warn$1$1(`withAsyncContext called without active current instance. ` +
  ...
  const useSSRContext = () => {
      {
          ...
          if (!ctx) {
              warn$1$1(`Server rendering context not provided. Make sure to only call ` +
  ...
  prevChildren, parentComponent, parentSuspense, unmountChildren) {
      ...
      try {
          ...
          if (!needRemove) {
              warn$1$1(`Failed setting prop "${key}" on <${el.tagName.toLowerCase()}>: ` +
  ...
  class VueElement extends BaseClass {
      constructor(_def, _props = {}, hydrate) {
          ...
          if (this.shadowRoot && hydrate) {
              ...
              if (this.shadowRoot) {
                  warn$1$1(`Custom element has pre-rendered declarative shadow root but is not ` +
  ...
  function validateDuration(val) {
      if (typeof val !== 'number') {
          warn$1$1(`<transition> explicit duration is not a valid number - ` +
              `got ${JSON.stringify(val)}.`);
      }
      else if (isNaN(val)) {
          warn$1$1(`<transition> explicit duration is NaN - ` +
          ...
          return () => {
              ...
              for (let i = 0; i < children.length; i++) {
                  ...
                  if (child.key != null) {
                      ...
                      warn$1$1(`<TransitionGroup> children must be keyed.`);
                  }
              }
              if (prevChildren) {
  ...
  function setSelected(el, value) {
      ...
      if (isMultiple && !isArray$1(value) && !isSet(value)) {
          warn$1$1(`<select multiple v-model> expects an Array or Set value for its binding, ` +
  ...
  function injectCompilerOptionsCheck(app) {
      if (isRuntimeOnly()) {
          ...
          Object.defineProperty(app.config, 'isCustomElement', {
              ...
              set() {
                  warn$1$1(`The \`isCustomElement\` config option is deprecated. Use ` +
  ...
  function genNodeListAsArray(nodes, context) {
      const multilines = nodes.length > 3 ||
          (nodes.some(n => isArray$1(n) || !isText$1(n)));
      context.push(`[`);
...
`stop,prevent,self,`   +
  ...
  function compileToFunction(template, options) {
      if (!isString(template)) {
          if (template.nodeType) {
              ...
              warn$1$1(`invalid template option: `, template);
              return NOOP;
          }
      }
      const key = template;
      ...
      if (template[0] === '#') {
          ...
          if (!el) {
              warn$1$1(`Template element not found or is empty: ${template}`);
          }
          // __UNSAFE__
          // Reason: potential execution of JS expressions in in-DOM template.
  ...
  var ProductItem = defineComponent({
      props: {
          product: {
              type: Object,
              required: true,
  ...
  var ShoppingListView = defineComponent({
      setup() {
          const route = useRoute();
          const list = ref();
          const message = ref("");
          const totalPrice = computed$1(() => {
              if (list.value) {
